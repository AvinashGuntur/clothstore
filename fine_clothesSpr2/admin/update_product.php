...
?>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="p_name" value="<?php echo $final['p_name']?>">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="p_price" value="<?php echo $final['p_price'] ?>">
                                <p class="help-block"></p>
                            </div>
							
							<div class="form-group">
                                <label>Product Description</label>
                                <textarea class="form-control" name="p_desc" rows="10" cols="15" value="<?php echo $final['p_desc'] ?>"></textarea>
                                <p class="help-block"></p>
                            </div>
							
						 <div class="form-group">
                                <label>Quantity Available</label>
                                <input type="number" class="form-control" name="p_qty" value="<?php echo $final['p_qty'] ?>">
                                <p class="help-block"></p>
                            </div>
							
							 <div class="form-group">
                                <label>Product Image</label>
                                <input type="file" name='image' value="<?php echo $final['p_image'] ?>">
                            </div>
							<br>
