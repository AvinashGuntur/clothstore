                            ...
                            <table class="table table-bordered table-hover">
								...
								while($row=mysqli_fetch_array($run)){
                                    ...
                                    <tr>
										...
										<td align='center'>
						   <a href='view_brand.php?edit_id=$id' class='btn btn-primary' style=''><i class='fa fa-pencil' aria-hidden='true'></i></a>                            
										</td>
										<td>
										<a href='view_brand.php?d_id=$id' class='btn btn-danger' style=''><i class='fa fa-trash-o' aria-hidden='true'></i></a>
										</td>
                                    </tr>
									";
								}
		...
		<?php 
		   if(isset($_GET['edit_id'])){
			   ...
			   $row=mysqli_fetch_array($query);
				   ...
				   <form method='post' action='view_brand.php?u_id=$e_id'>
