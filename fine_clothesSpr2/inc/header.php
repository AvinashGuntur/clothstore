...
<body>
	<header id="header" ><!--header-->
			...
			<div class="container-fluid nav-bar-top">
				<div class="row">
					<div class="col-sm-4">
						...
						<!-- <table>
						<tr><td><img src="images/logo.png" class="new" alt=""  height=100 width=100/></td>
						<td><h2>Fine Clothes</h2></td></tr>
						</table> -->
						<div class="nav-brand d-flex"> 
							<img src="images/logo.png" class="new" alt=""  height=100 width=100/>
							<h2>Fine Clothes</h2>
						</div>
 						</div>
		...
		<div class="header-bottom"><!--header-bottom-->
			...
			<div class="container-fluid nav-bar-bottom">
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<a href="javascript:void(0)" class="btn btn-info" style="position:absolute;right:0px;" id="search_btn"><span class="glyphicon glyphicon-search"></span></a>
